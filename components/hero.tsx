...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    // named handler so it can be removed in cleanup
      ...
      >
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-12">
            <TextGenerateEffect
              words="My design journey is fueled by a passion for problem-solving, ensuring that each project I undertake is not just visually appealing but also user-centric."
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <motion.a
              href="#process"
              className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-primary to-accent rounded-lg font-medium hover:shadow-lg transition-all focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 text-secondary-foreground"
            ...
            {/* <motion.a
              // href="/api/resume"
              // href="https://drive.google.com/file/d/1aZvVJaHFNuiUB2zy0LENE-gVqqkkkfwe/view"
              
              download="https://drive.google.com/file/d/1aZvVJaHFNuiUB2zy0LENE-gVqqkkkfwe/view"
