...
import { Palette, Layers, PenTool, Wrench } from "lucide-react"
...
export default function Skills() {
  const skillCategories = [
    ...
    },
    {
      title: "UX Design",
      icon: Layers,
      skills: ["UX Research", "Competitive Analysis", "Usability Testing", "User Flow", "Wireframing", "Prototyping"],
      color: "from-purple-500 to-pink-500",
    },
    {
      title: "Graphic Design",
      icon: PenTool,
      skills: ["Logo Design", "Social Media Design", "Thumbnail Design", "Branding Design"],
  ...
  const itemVariants = {
    ...
    visible: {
      opacity: 1,
      y: 0,
      transition: { duration: 0.6, ease: [0.0, 0.0, 0.2, 1] as any },
    },
  }
